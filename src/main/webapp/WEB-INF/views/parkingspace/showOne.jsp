...
<ul class="itemlist">
    ...
    <br>
    <c:if test="${(currentUser.id == parkingspace.owner.id) || currentUser.admin}">
        <li><a href="/parkingspace/edit/${parkingspace.id}" class="btn btn-danger mx-1" id="addbutt">edit</a> <a
                href="/parkingspace/delete/${parkingspace.id}" class="btn btn-danger mx-1" id="addbutt">delete</a>
        </li>
    </c:if>
</ul>
